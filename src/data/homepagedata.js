export const homepagedata={
    ...
    text2: `Visit the “Information” page to learn more about feminism. The “Evaluation” page provides a description of how to use 
        this critical theory when looking at a work, along with an example of using this critical theory on the text Harry Potter 
        and the Sorcerer’s Stone. Finally, the “Survey” page provides information about using the Bechdel test to see if a film 
