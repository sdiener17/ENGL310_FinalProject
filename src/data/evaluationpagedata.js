export const evaluationpagedata = {
    ...
    text6:`*Harry Potter and the Sorcerer’s Stone* is the first book in a very popular series by J. K. Rowling. The books feature a 
        young wizard named Harry Potter as he grows up and attends Hogwarts, a school of witchcraft and wizardry, and eventually 
        defeats an evil wizard who is trying to take over. Harry is almost constantly accompanied by his friends, Ron Weasley and 
        Hermione Granger, who help him save the world from the evil wizard Voldemort. Harry, Ron, and Hermione are the three main 
        characters of the series, though there are a variety of other characters used as friends or enemies throughout the book, 
        such as Neville Longbottom or Bellatrix Lestrange. Since I will be focusing only on the first book of the series, I will be 
        looking mainly at Hermione Granger, since there are not many other named female characters in the first book.`,
    text7:`At a glance, *Harry Potter and the Sorcerer’s Stone* seems to be free of gender stereotypes. Both males and females 
        can attend the wizarding school of Hogwarts, and they receive equal schooling as well as equal access to the school’s 
        main sport, quidditch. Besides that, one of the main characters, Hermione Granger, is female and is portrayed as extremely 
        smart and confident. Her house is Gryffindor, which implies that she is brave, and she ends up being extremely important to 
        Harry as the series progresses. A first impression could be that Hermione is a positive role model and the perfect example 
        of a girl breaking free from stereotypes. However, a closer reading would suggest that maybe this book isn’t quite as 
        female-friendly as meets the eye.`,
    text8:`The first thing to be noted is the lack of female characters in the first book. While several other females show up in 
        later books, most of them are unimportant and only used for a short time, such as Harry’s girlfriend Cho Chang. 
        There are a greater number of important male characters, which could suggest a lack of importance placed on females. 
        This lack of gender representation could be discouraging to young girls who want to see other females being treated as 
        important. Hermione and Professor Minerva McGonagall are the only two important females in the first book, and I will be 
        focusing mainly on Hermione for the purposes of this interpretation. `,
    text9:`Though Hermione is smart, she gets constantly made fun of for it. At one point, Hermione is sharing tips about flying a 
        broomstick, but it is clear that no one wanted to listen to her (“she bored them all stupid with flying tips she’d gotten out 
        of a library book… everybody else was very pleased when Hermione’s lecture was interrupted by the arrival of the mail.” 
        (Rowling 144)). A while later, it’s stated that “Hermione was now refusing to speak to Harry and Ron, but she was such a 
        bossy know-it-all that they saw this as an added bonus.” (Rowling 164). At another point, Hermione corrects Ron’s 
        ...
        *Harry Potter* books. She states, “This implies that they do not consider themselves to be friends with her, even though 
        ...
        This indirectly sends a message to young girls that they can’t be confident in their knowledge at risk of appearing unfeminine 
        (Powers). Hermione overhears Ron’s comment, and “reverts back into the female stereotype by running to the restroom and crying 
        over her hurt feelings” (Powers). While some may see showing Hermione’s emotion as adding depth to her character, it is also 
        possible to view this as showing that women can’t handle their emotions. A short while later, Hermione sees a troll in the 
        bathroom and screams, shrinking against the wall in fear. This is uncharacteristic of her and shows that “her emotions 
    ...
    text10:`Hermione is also given a sort of motherly role throughout the books. Melanie Cordova touches on this in her article about 
        ...
        function as her own character with the ability to live how she wishes, but she must conform to the roles that the men 
        in her life put her into.`,
    text11:`Overall, while Hermione Granger may seem like a great picture of females being respected in the literary world, there are 
        still several flaws to her representation that may perpetuate certain stereotypes. Taking a deep dive into literary works to 
        find these hidden stereotypes can help people recognize them in their own lives and help them view women in a more serious and 
        respectful light.`
}